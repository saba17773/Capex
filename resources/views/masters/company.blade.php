                ...
                <tbody>
                  ...
                  <tr>
                    <td width="1%"><div class="icheck-primary d-inline">
                      <input type="radio" id="rdoCompany_<?php echo $i;?>" name="company" value="<?php echo $value->Company;?>">
                      <label for="rdoCompany_<?php echo $i;?>">
                      </label>
                    </div></td>
                    <td><?php echo $i;?></td>
        ...
        <div class="container-fluid">
          <div class="row">
            ...
            <div class="col-md-4">
              ...
              <input id="txtCompany" type="text" class="form-control"  autocomplete="off">
            </div>
            <div class="col-md-8">
              <!-- general form elements -->
