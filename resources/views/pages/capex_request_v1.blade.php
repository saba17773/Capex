              ...
              <table  id="tblrequest" class="table table-bordered" >
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      {{-- <select id="sel_dproute"  name = "sel_dproute" class="form-control select2">
                        @foreach ($deptroute as $route)
                          <option value="{{ $route->CodeCD }}">{{ $route->CodeCD }}</option>
                        @endforeach
                        <option value="1">detail-01</option>
                      </select> --}}
